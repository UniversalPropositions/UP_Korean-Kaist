...
- `git clone https://github.com/UniversalPropositions/UP_Korean-Kaist.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Korean-Kaist>/ --input_up=<up_path_to_UP_Korean-Kaist>/ --output=<path_to_UD+UP_Korean-Kaist>/`
